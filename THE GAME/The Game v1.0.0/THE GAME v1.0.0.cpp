...
bool Block_MoveChain(Vector2 *_position,Player *_player,char _code,Block _block[][302])
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
//Input Handler
void Input(bool &A_Quit, GameState &_gameState,Player *&_player,Block _block[][302],TeleportHash _tph[],int _tpCount, int &currentLevel,char _fileName[],int _atvCount,Vector2 _atvPos[])
{
	if(kbhit())
	{
		switch(getch())
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
//Data Handling
void LoadGame(char _fileName[50],FILE *_fptr,Player *&_player,Block _blockArr[][302],TeleportHash _tph[],int &_tpCount ,int &currentLevel,bool &_gameSaved,char _saveName[],int &_atvCount, Vector2 _atvPos[])
{
...
void SaveGame(Block _blockArr[][302],FILE *_fptr,char _fileName[50],int _currentLevel,int _tpCount, TeleportHash _tph[],Player *_player,bool &_gameSaved,char _saveName[],int _atvCount,Vector2 _atvPos[])
{
...
void SaveProgress(int _index,Block _blockArr[][302],FILE *_fptr,char _fileName[50],int _currentLevel,int _tpCount, TeleportHash _tph[],Player *_player,bool &_gameSaved,char _saveName[],SavedFile _fileProperties[],int currentLevel,char _strArr [][50],int _atvCount,Vector2 _atvPos[])
{
...
void PauseMenuUI(GameState &_gameState,bool &A_Quit,Block _blockArr[][302],FILE *_fptr,char _fileName[], int &currentLevel,int &_tpCount,TeleportHash _tph[],Player *_player,bool _gameSaved,SavedFile _fileProperties[],char _saveName[],int _atvCount,Vector2 _atvPos[])
{
	int maxNum = 4;
	int currentNum = 0;
	char _nameArr[maxNum+2][50];
...
void DrawGame(Window *_window,Block _block[][302],Player *_player,int currentLevel,/*Debug*/TeleportHash _tph[],int _tpCount,Vector2 _atvPos[],int _atvCount)
{
	system("cls");
	//Game Window
